...
function denyWager(message){verdictView.textContent=message;wagerInput.classList.remove('rl-deny-67df28c0');void wagerInput.offsetWidth;wagerInput.classList.add('rl-deny-67df28c0');}
...
var brandEl=document.querySelector('.rl-brand-67df28c0');var echoEl=grab('rl-echo');if(brandEl&&echoEl){echoEl.textContent=brandEl.textContent.replace(/\s+/g,' ').trim();}
